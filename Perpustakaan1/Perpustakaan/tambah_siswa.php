...
<body>
    ...
    <center><h3>Tambah Siswa</h3>
    <a href="index.php" type="button" class="btn btn-success" >Home</button></a>
    </center>
    <br>
    <form action="proses_tambah_siswa.php" method="post">
        ...
        <select name="id_jurusan" class="form-control">
            ...
            <?php 
            include "koneksi.php";
            $qry_kelas=mysqli_query($conn,"select * from jurusan");
            while($data_kelas=mysqli_fetch_array($qry_kelas)){
                echo '<option value="'.$data_kelas['id_jurusan'].'">'.$data_kelas['jurusan'].'</option>';    
            }
            ?>
        </select>
        Username : 
